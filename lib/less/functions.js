...
tree.functions = {
    ...
    "image-width": function(image) {
        return new tree.ImageDimension(image, 'width', this.currentFileInfo).eval(this.env);
    },

    "image-height": function(image) {
        return new tree.ImageDimension(image, 'height', this.currentFileInfo).eval(this.env);
    },
    ...
    "data-uri": function(mimetypeNode, filePathNode) {
        ...
        filePath = this.env.resolvePath(filePath, this.env, {absolute: true});
